...
import {useGetShowReviewsQuery} from "@/services/tmdb/reviewsApi.ts";

type TvShowReviewsProps = {
    tvShowId: number;
};

export const TvShowReviews = ({tvShowId}: TvShowReviewsProps) => {
    const {data, isLoading, error} = useGetShowReviewsQuery(tvShowId!)
