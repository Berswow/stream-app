...
import { MOVIE_GENRES, TV_GENRES } from "@/shared/constants/genres.ts"; // Предполагаем, что у тебя есть константы для жанров фильмов и сериалов
                ...
                >
                    {paginatedGenres.map((genre) => {
                        ...
                        return (
                            <div
                                key={genre}
                                className="flex flex-col items-center rounded-2xl p-8 bg-neutral-800 cursor-pointer hover:shadow-[0px_5px_10px_5px_#000000] transition-shadow duration-500"
