...
import {imageShowsTrendArray, imageShowsNewReleasesArray, imageShowsMustWatchArray} from "@/utils/images.ts";
                    ...
                    <div className='flex justify-between gap-5'>
                        {[...new Array(4)].map((_, i) => (
                            <div className='flex flex-col items-center rounded-2xl p-8'
                                ...
                                <div className="relative rounded-2xl overflow-hidden">
                                    <div key={i} className="flex">
                                        <img src={imageShowsMustWatchArray[i]} alt={`Image ${i}`} className="rounded-lg"/>
                                    </div>
                                    <div
                                        className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent"/>
                                </div>
